...
{
    /// <inheritdoc />
<<<<<<<< HEAD:Infrastructure/Migrations/20231120175726_Mi1.cs
    public partial class Mi1 : Migration
========
    public partial class InitialCreate : Migration
>>>>>>>> aa1a7dcf691960d672bbd0f645bbacbdb531dffc:Infrastructure/Migrations/20231120210655_InitialCreate.cs
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Phones", x => new { x.PhoneNumber, x.UserID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductIdentities", x => new { x.SerialNumber, x.ProductID });
                    table.ForeignKey(
                        name: "FK_ProductIdentities_Products_ProductID",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductIdentities_ProductID",
